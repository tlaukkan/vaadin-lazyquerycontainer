...
public class JpaQueryFactory<T> implements QueryFactory {
     ...
     * @param beanClass
     *            The value bean class.
     * @param jpaSelectQuery
     *            The select query used to select batches of value beans.
     * @param jpaSelectCountQuery
     *            The select count query which returns total number of beans.
     * @param nativeSortPropertyIds
     *            The properties used in native sort.
     * @param nativeSortStates
     *            The native sort states. True corresponds ascending and false
     *            descending.
     * @param transactionManagement
     *            True if application managed transactions are to be used.
     */
    public JpaQueryFactory(EntityManager entityManager, Class<T> beanClass, String jpaSelectQuery,
            String jpaSelectCountQuery, Object[] nativeSortPropertyIds, boolean[] nativeSortStates,
            boolean transactionManagement) {
        super();
    ...
    public Query constructQuery(Object[] sortPropertyIds, boolean[] sortStates) {
        return new JpaQuery<T>(beanClass, entityManager, jpaSelectQuery, jpaSelectCountQuery, definition,
